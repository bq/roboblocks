// 2015-09-10 tłumaczenie z angielskiego przez/translated from english by: AMOsPL
// v1.0 ET (exactly translated keywords&operators version)
'use strict';
(function() {
var language = {
//GUI:
BLOCKLY_MSG_DUPLICATE_BLOCK: 'Duplikuj Blok',
...
LANG_ADVANCED_SERIAL_PRINT: 'Druk tekstu przez port szeregowy',
LANG_ADVANCED_SERIAL_PRINT_TOOLTIP: 'Drukuje dane jako tekst ASCII.',
LANG_ADVANCED_SERIAL_PRINTLN: 'Druk linii tekstu przez port szeregowy',
...
LANG_ADVANCED_SERIAL_SPECIAL_TOOLTIP: 'Zapisuje znaki specjalne.',
//bloki bq :
LANG_CATEGORY_BQ: 'Urządzenia',
...
LANG_BQ_LED_ON: 'Włączony',
LANG_BQ_LED_OFF: 'Wyłączony',
...
LANG_CONTROLS_IF_TOOLTIP_1: 'Jeśli warunek jest prawdą, wykonaj polecenia.',
LANG_CONTROLS_IF_TOOLTIP_2: 'Jeśli warunek jest prawdą, wykonaj pierwszy blok poleceń. W przeciwnym przypadku wykonaj drugi blok poleceń.',
LANG_CONTROLS_IF_TOOLTIP_3: 'Jeśli pierwszy warunek jest prawdą, wykonaj pierwszy blok poleceń. W przeciwnym przypadku, jeśli druga wartość jest prawdą, wykonaj drugi blok poleceń.',
LANG_CONTROLS_IF_TOOLTIP_4: 'Jeśli pierwszy warunek jest prawdą, wykonaj pierwszy blok poleceń. W przeciwnym przypadku, jeśli druga wartość jest prawdą, wykonaj drugi blok poleceń. Jeśli żadna z wartości nie jest prawdą, wykonaj ostatni blok poleceń.',
LANG_CONTROLS_IF_MSG_IF: 'Jeśli',
LANG_CONTROLS_IF_MSG_ELSEIF: 'W przeciwnym razie Jeśli',
LANG_CONTROLS_IF_MSG_ELSE: 'W przeciwnym razie',
LANG_CONTROLS_IF_MSG_THEN: 'Wykonaj',
LANG_CONTROLS_IF_IF_Field_IF: 'Jeśli',
LANG_CONTROLS_IF_IF_TOOLTIP: 'Dodaj, usuń lub zmień kolejność sekcji aby przeorganizować blok JEŚLI.',
LANG_CONTROLS_IF_ELSEIF_Field_ELSEIF: 'W przeciwnym razie Jeśli',
LANG_CONTROLS_IF_ELSEIF_TOOLTIP: 'Dodaj warunek do bloku JEŚLI.',
LANG_CONTROLS_IF_ELSE_Field_ELSE: 'W przeciwnym razie',
LANG_CONTROLS_IF_ELSE_TOOLTIP: 'Dodaj ostatni warunek do bloku JEŚLI przechwytujący wszystkie pozostałe możliwości wykonania poleceń.',
...
LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE: 'Za każdym razem dopóki warunek jest prawdą, wykonuj polecenia.',
LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL: 'Za każdym razem dopóki warunek jest fałszem, wykonuj polecenia',
...
LANG_CONTROLS_FLOW_STATEMENTS_WARNING: 'Ostrzeżenei: Ten blok może być użyty tylko w pętli.',
...
LANG_CONTROLS_SWITCH_DEFAULT_TOOLTIP: 'Po słowie kluczowym DOMYŚLNIE wykonają się polecenia, jeśli żaden z przypadków nie pasuje',
LANG_CONTROLS_SWITCH_IS: 'przypadek: ',
...
LANG_ARRAY_GET_TOOLTIP: 'Zwraca wartość Returns the value of a certain element of the array.',
LANG_MATH_MODULO_TOOLTIP: 'Zwraca resztę z dzielenia dwóch liczb wejściowych.',
LANG_MATH_BASE_MAP: 'Skaluj ',
LANG_MATH_BASE_MAP_VALUE_TO: 'Wartość do [0-',
...
LANG_MATH_SINGLE_OP_ABSOLUTE: 'bezwzględna',
...
LANG_ADVANCED_BUILTIN_LED_ON: 'Właczony',
...
LANG_ADVANCED_HIGHLOW_TOOLTIP: 'WYSOKI LUB NISKI',
...
LANG_PROCEDURES_IFRETURN_TOOLTIP: 'Jeśli warunek jest prawdą, zwraca tę wartość.',
...
LANG_ZUM_FOLLOWER_TOOLTIP: 'Zwraca wartość cyfrową odczytaną przez czujnik podczerwieni',
LANG_ZUM_INFRARED: 'Czujnik podczerwieni',
LANG_ZUM_INFRARED_PIN: 'PIN#',
LANG_ZUM_INFRARED_TOOLTIP: 'Zwraca wartość cyfrową odczytaną przez czujnik podczerwieni',
LANG_ZUM_LED: 'Dioda LED',
LANG_ZUM_LED_PIN: 'PIN#',
LANG_ZUM_LED_ON: 'WŁĄCZ',
LANG_ZUM_LED_OFF: 'WYŁĄĆZ',
LANG_ZUM_LED_TOOLTIP: 'zum LED',
LANG_ZUM_PHOTORESISTOR: 'Czujnik światła',
LANG_ZUM_PHOTORESISTOR_PIN: 'PIN#',
LANG_ZUM_PHOTORESISTOR_TOOLTIP: 'Zwraca wartość analogową zmierzoną przez czujnik światła.',
...
LANG_ZUM_PIEZO_BUZZERAV_TOOLTIP: 'Brzęczyk piezoelektryczny zaawansowany',
LANG_ZUM_POTENTIOMETER: 'Potencjometr',
LANG_ZUM_POTENTIOMETER_PIN: 'PIN#',
LANG_ZUM_POTENTIOMETER_TOOLTIP: 'Zwraca wartość analogową ustawioną na potencjometrze.',
//bloki serwomechanizmów :
LANG_CATEGORY_SERVO: 'Serwomechanizm',
LANG_SERVO_CONT: 'Serwo ciągłego obrotu',
...
LANG_SERVO_CONT_TOOLTIP: 'Serwo ciągłego obrotu.',
...
LANG_SERVO_MOVE_TOOLTIP: 'Obrót w zakresie 0~180 stopni',
